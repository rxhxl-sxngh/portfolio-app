    ...
    <div className="portfolio-visualizer">
      ...
      <div id="ui-overlay">
        ...
        <div className="nav-left">
          <button className="nav-button" onClick={() => setActiveSection('about')}>
            ABOUT
          </button>
          <button className="nav-button" onClick={() => setActiveSection('projects')}>
            PROJECTS
          </button>
        </div>
        ...
        <div className="nav-right">
          <button className="nav-button" onClick={() => setActiveSection('experience')}>
            EXPERIENCE
          </button>
          <button className="nav-button" onClick={() => setActiveSection('writing')}>
            WRITING
          </button>
        </div>
        ...
        <div className="social-icons">
          <a href="https://github.com/rxhxl-sxngh" target="_blank" rel="noopener noreferrer" className="social-icon">
          ...
          <a href="mailto:rahulsingh@example.com" className="social-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
